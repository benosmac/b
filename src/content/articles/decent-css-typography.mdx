...
tags:
  ...
  - Typography
published: true
last_edited_time: '2023-07-31T11:42:00.000Z'
...
CSS Values Level 4[ includes the lh (line-height) and rlh (root line-height) units](https://www.w3.org/TR/css-values-4/#lh), which are perfect for this, but[ browser support just isn’t there yet](https://caniuse.com/mdn-css_types_length_rlh) (as of writing, only Safari 16.4+ supports `rlh`).
