...
tags:
  ...
  - Colour
published: true
last_edited_time: '2023-06-24T13:47:00.000Z'
...
The CodePen below demonstrates some of what can be achieved - just change the —brandColour custom property to generate all sorts of relative colours!
...
I also found that the following doesn’t work in Firefox
